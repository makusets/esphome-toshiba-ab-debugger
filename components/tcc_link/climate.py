...
).extend(uart.UART_DEVICE_SCHEMA).extend(cv.COMPONENT_SCHEMA).extend(i2c.CONFIG_SCHEMA)
#need to include all the extended schemas that are used in the component
