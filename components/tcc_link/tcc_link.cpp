    ...
    case TOSHIBA_MASTER:
      ...
      switch (frame->opcode1) {
        ...
        case OPCODE_EXTENDED_STATUS:
          ...
          tcc_state.room_temp = toshiba_temperature;  // id of temp sensor created in YAML that will be used to incorporate current temp into the tcc component, nullptr ensures no errors if variable is null
